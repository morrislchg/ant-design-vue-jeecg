    ...
    <j-form-container :disabled="formDisabled">
      ...
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="12" >
            <a-form-item label=" 业务范围 " :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['businessScope']" placeholder="请输入 业务范围 "></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="12" >
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      editAfter() {
        let fieldval = pick(this.model,'enterpriseName','legalRepresentative','unifiedSocialCreditCode','region','natureOfEnterprise','enterpriseWebsite','address','businessScope','updateTime')
        this.$nextTick(() => {
     ...
     popupCallback(row){
       this.form.setFieldsValue(pick(row,'enterpriseName','legalRepresentative','unifiedSocialCreditCode','region','natureOfEnterprise','enterpriseWebsite','address','businessScope','updateTime'))
     },
